...
dat.l <- alldata
`%!in%` <- Negate(`%in%`)
dat.l <- subset(alldata, patient %!in% c("P0411","P0720","P1212","P1228","P20181211","P1025"))
```
...
[Issue#4628](https://github.com/satijalab/seurat/issues/4628) exists on GitHub with bug label but no responses.  
